...
import { process_and_validate, extract_and_return_file_path_and_name } from './utils.js';
...
const { changesetFilePath, changesetFile } = extract_and_return_file_path_and_name(output);
